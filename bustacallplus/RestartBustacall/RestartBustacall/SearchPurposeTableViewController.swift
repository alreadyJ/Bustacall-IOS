//
//  SearchPurposeTableViewController.swift
//  RestartBustacall
//
...
class SearchPurposeTableViewController: UITableViewController {
...
//    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "startPurposeSegue"{
        ...
        if segue.identifier == "endPurposeSegue"{
